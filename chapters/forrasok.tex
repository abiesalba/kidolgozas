...
\begin{itemize}
	...
	\end{compactitem}
	\item Az ókori Görögország
	\begin{compactitem}
		\item \url{https://hu.wikipedia.org/wiki/\%C3\%93kori_g\%C3\%B6r\%C3\%B6g_vall\%C3\%A1s}
		
		\item \url{https://hu.wikipedia.org/wiki/\%C3\%93kori_G\%C3\%B6r\%C3\%B6gorsz\%C3\%A1g}
		
		\item \url{https://hu.wikipedia.org/wiki/M\%C3\%BCk\%C3\%A9n\%C3\%A9i_kult\%C3\%BAra}
	\end{compactitem}
